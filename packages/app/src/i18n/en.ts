export const dict = {
  ...
  "settings.general.row.iconPreset.title": "Icon style",
  "settings.general.row.iconPreset.description": "Choose the icon set used throughout OpenCode",
  "settings.general.row.iconPreset.option.sharp": "Sharp",
  "settings.general.row.iconPreset.option.soft": "Soft",
